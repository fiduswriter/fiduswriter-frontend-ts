...
echo "Building @fiduswriter/common..."
npm run build
...
git add .
git commit -m "Deploy @fiduswriter/frontend to Forgejo Pages"
...
cd "$ROOT"
rm -rf "$BUILD_DIR"
echo "Done. Available at https://fiduswriter.pages.fiduswriter.org/fiduswriter-frontend-ts/"
